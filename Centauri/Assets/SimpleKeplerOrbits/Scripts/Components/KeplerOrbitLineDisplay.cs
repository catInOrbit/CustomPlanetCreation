...
namespace SimpleKeplerOrbits
{
    ...
    public class KeplerOrbitLineDisplay : MonoBehaviour
    {
        ...
        private SimpleOrbitDataDisplay simpleOrbitData;
        ...
        private void Start()
        {
            simpleOrbitData = GetComponent<SimpleOrbitDataDisplay>();
        }
        ...
        private void ShowReentry()
        {
            _moverReference.OrbitData.GetOrbitPointsNoAlloReentry(ref _orbitPoints, OrbitPointsCount, _moverReference.AttractorSettings.AttractorObject.position, MaxOrbitWorldUnitsDistance);
